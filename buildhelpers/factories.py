...
from buildhelpers.commands import (
    ...
    checkinstall, cat_deb_version, cat_src_version, git_revparse,
    rm_build_packages, rm_incoming_packages)
from buildhelpers.common import (
    ...
    deb_version_extract, src_version_extract, git_revision_extract)
...
packaging = BuildFactory([
    ...
    SetPropertyFromCommand(command=git_revparse,
                           extract_fn=git_revision_extract,
                           flunkOnFailure=False),
